...
static DeviceAddress DS18B20_W = { 0x28, 0x41, 0x49, 0x95, 0xF0, 0x01, 0x3C, 0x72 };
static DeviceAddress DS18B20_A = { 0x28, 0xA4, 0x02, 0x42, 0x0C, 0x32, 0x20, 0xDE };
